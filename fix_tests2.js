...
dirs.forEach(file => {
  ...
  content = content.replace(/permissions: \[\]/, "permissions: ['meeting-rooms-bookings:view', 'meeting-rooms-bookings:create', 'facilities:view', 'meeting-rooms:view', 'meeting-rooms:create', 'helpdesk:view', 'helpdesk:create', 'visitors:view']");
