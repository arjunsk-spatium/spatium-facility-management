<template>
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
                <h1 class="text-2xl font-bold dark:text-white">Management Staff</h1>
                <p class="text-gray-600 dark:text-gray-400">Manage portal users, access permissions, and facility assignments</p>
            </div>
