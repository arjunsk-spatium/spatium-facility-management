    ...
    <div class="space-y-6">
        ...
        <template v-else>
            ...
            <div v-else-if="facilityStore.totalFacilities === 0"
                ...
                <p class="text-gray-500 max-w-sm text-center mb-6">Get started by creating your first facility
                    structure.
                </p>
                <a-button v-if="canCreate" type="primary" @click="navigateTo('/facilities/create')">Create
                    Facility</a-button>
            </div>
            ...
            <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
                <a-card v-for="facility in facilityStore.facilities" :key="facility.id">
                    ...
                    <template #cover>
                        <div
                            class="h-32 bg-blue-50 dark:bg-blue-900/10 flex items-center justify-center overflow-hidden">
                    ...
                    <template #actions>
                        <div v-if="canUpdate" class="flex justify-center w-full"
                            @click.stop="navigateTo(`/facilities/${facility.id}/edit`)">
                        ...
                        <a-popconfirm v-if="canDelete" title="Are you sure you want to delete this facility?"
                            ok-text="Yes" cancel-text="No" @confirm="handleDeleteFacility(facility.id)">
